  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 503: /***/ (
        ...
        return new Promise((resolve, reject) => {
          ...
          child.on("close", (code) => {
            if (code === 0) {
              ...
              reject(
                new ExecError([cmd, ...args].join(" "), code, stdout, stderr)
              );
            }
          });
        });
      ...
      const isStatus = (status) =>
        Object.values(DiffStatus).includes(status) ||
        ...
        return __awaiter(this, void 0, void 0, function* () {
          ...
          if (
            (_a =
              options === null || options === void 0
                ? void 0
                : options.statuses) === null || _a === void 0
              ? void 0
              : _a.length
          ) {
          ...
          if (
            (_b =
              options === null || options === void 0
                ? void 0
                : options.paths) === null || _b === void 0
              ? void 0
              : _b.length
          ) {
            args.push(...options.paths);
          }
          const { stdout } = yield exec(cmd, args, {
